...
* author: Preston Thronson
* class: CS 1400.01 Intro Programming Prob Solving
*
* assignment: Program 1
* date last modified: 8/29/2024
*
* purpose: This program is used to display Ascii art of the Pokemon character Charizard
*
*/

//This class, Lab Program, is where the ASCII of Charizard art is ran via println statements. It prints out one line at a time to read better in the code.
